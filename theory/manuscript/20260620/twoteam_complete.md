...
たとえば自分の構築はまったく同じでも、相手がたまたま自分にとって「有利な向き」に位置していれば勝ちやすいし、逆の向きに来れば苦しい。対戦でいう「相性」とか「噛み合い」みたいな、**相手との位置取りの運**の部分ですね。これを相手側をどれだけ回したかというパラメータ $\theta$ で表します。
...
- 網羅的に$v_1,v_2$ の半径や角度を変えたときの**グラフ列挙**
